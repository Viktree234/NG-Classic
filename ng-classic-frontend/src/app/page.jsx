  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-rose-100 via-pink-200 to-pink-300 py-24 px-6 text-center">
        ...
        <h1 className="font-playfair text-5xl md:text-6xl text-rose-900 mb-6 leading-tight">
          Luxury Hair,<br />
          <span className="text-rose-600">Your Way</span>
        </h1>
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <h2 className="font-playfair text-3xl text-center text-rose-900 mb-12">
          Featured Products
        </h2>
        {products.length === 0 ? (
          <p className="text-center text-gray-400">No products yet. Check back soon!</p>
        ) : (
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ...
            <div key={item.title} className="p-6">
              <div className="text-rose-400 text-2xl mb-3">{item.icon}</div>
              <h3 className="font-playfair text-lg text-rose-900 mb-2">{item.title}</h3>
