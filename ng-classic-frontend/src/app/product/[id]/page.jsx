...
export default function ProductPage({ params }) {
  ...
  if (!product) return <div className="max-w-4xl mx-auto p-12 text-center text-gray-400">Product not found.</div>;
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h1 className="font-playfair text-3xl text-rose-900 mt-2 mb-4">{product.name}</h1>
